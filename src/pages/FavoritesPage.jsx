  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-16 border-b border-gray-100 pb-8">
            ...
            <div className="text-right hidden md:block">
                <span className="text-xs font-bold uppercase tracking-widest text-gray-400">
                    {t('favorites.total_items', { count: favorites.length })}
                </span>
            </div>
        </div>
        ...
        {/* --- İÇERİK ALANI --- */}
        {loading ? (
          <div className="text-center py-32 text-xs tracking-widest uppercase animate-pulse">{t('favorites.loading')}</div>
        ) : favorites.length > 0 ? (
