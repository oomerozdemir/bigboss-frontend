...
import { useCart } from '../context/CartContext'; // DÜZELTME: useCart kullanıldı
import MainLayout from '../components/MainLayout';
import { useNavigate } from 'react-router-dom';

const CheckoutPage = () => {
  // DÜZELTME: Context'ten doğru veriler çekildi
  ...
  // Kargo Hesabı (CartPage ile aynı mantık)
                  ...
                  {cartItems.map((item, index) => (
                    <div key={`${item.id}-${index}`} className="flex gap-4 items-center border-b border-gray-50 pb-2 last:border-0">
                      <div className="w-16 h-20 bg-gray-100 rounded overflow-hidden flex-shrink-0">
                         {/* DÜZELTME: item.imageUrl kontrolü */}
                         <img 
                      ...
                      <div className="flex-1">
                        ...
                        {/* DÜZELTME: selectedVariant kontrolü */}
