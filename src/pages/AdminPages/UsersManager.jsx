...
import { Users, Search, ShoppingBag, TrendingUp, Mail, Calendar } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
          ...
          <div>
            <p className="text-xs text-gray-500 font-medium uppercase tracking-wide">Alışveriş Yapan</p>
                ...
                filtered.map((user, idx) => (
                  <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-5 py-4 text-center">
                      {user.orderCount > 0 ? (
                        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-green-100 text-green-700 text-xs font-black">
                          {user.orderCount}
                        </span>
                      ) : (
